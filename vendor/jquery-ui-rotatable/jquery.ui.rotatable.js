...
$.widget("ui.rotatable", $.ui.mouse, {
    ...
    snapTo15degRot: function(snapTo15degRot){
        if(snapTo15degRot === undefined){
            return this.options.snapTo15degRot;
        }
        this.options.snapTo15degRot = snapTo15degRot;
    },
    ...
    rotateElement: function(event) {
        ...
        if (event.shiftKey || this.options.snapTo15degRot) {
